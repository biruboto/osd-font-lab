...
+ Instantly replace all typable characters with gorgeous bitmap fonts by [Damien Guard](https://damieng.com/typography/zx-origins/), or from the [Atari Eight Bit collection](https://github.com/a8bit/EightBit-Atari-Fonts), or by importing a .yaff file, like those available from the [Hoard of Bitfonts](https://github.com/robhagemans/hoard-of-bitfonts/tree/master)
